        ...
        <div className="relative mt-8">
          <Slider {...settings} ref={sliderRef} className="flex justify-center">
            {testimonials.map((testimonial) => (
              <div key={testimonial.id} className="px-4">
                <div className="bg-[#0A0E17] rounded-xl p-6 shadow-lg border-2 border-[#141E32] w-[420px] md:w-[380px] lg:w-[400px] mx-auto h-[260px] flex flex-col justify-between">
                  ...
                  {/* Testimonial Text */}
                  <p className="text-gray-400 flex-1 sm:text-[18px] text-[14px] mt-10 leading-relaxed">
                    {testimonial.text}
                  </p>
          ...
          <div className="flex justify-center gap-4 mt-6">
            <button
              ...
              className="w-10 h-10 flex items-center justify-center bg-gray-800 rounded-full text-white hover:bg-gray-600 transition"
            >
              ←
            </button>
            <button
          ...
          <div className="sm:hidden block mt-4">
            <button className="bg-[#6967AE] p-4 rounded-full cursor-pointer">Add comment</button>
          </div>
        </div>
      </div>
    </div>
