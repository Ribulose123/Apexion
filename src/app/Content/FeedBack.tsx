...
const FeedBack = () => {
  ...
  return (
    <div className="min-h-screen text-white p-6 max-w-6xl mx-auto mt-20">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="px-4 sm:px-6 flex justify-center">
        <div className="w-full max-w-3xl">
          ...
          <div className="w-full">
            <div className="sm:border sm:border-[#141E32] sm:bg-[#01040F] rounded-lg sm:p-6">
              ...
              <div className="mt-8">
                <h3 className="text-xl font-semibold mb-2">Upload Picture (Optional)</h3>
                <p className="text-[#F0798B] text-xs sm:text-sm font-semibold mb-4">
